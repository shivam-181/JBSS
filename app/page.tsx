  ...
  return (
    <div className="min-h-screen flex flex-col bg-background selection:bg-blue-500/30">
      ...
      <main className="flex flex-col items-center justify-center text-center p-6 pt-24 pb-20 md:pt-32 md:pb-32 overflow-hidden relative bg-gradient-to-b from-background to-secondary/20 dark:from-background dark:to-slate-900/50">
        ...
        <h2 className="text-lg md:text-2xl font-medium tracking-tight text-slate-900 dark:text-slate-300 max-w-3xl animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-300 z-10">
          Bihar’s Leading NGO-Driven Skill & Career Institute
        </h2>

        <p className="text-lg text-slate-800 dark:text-slate-300 max-w-2xl mb-10 leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300 mt-6 z-10">
