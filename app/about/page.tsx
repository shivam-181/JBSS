...
import { Building2, Users, Target, Award, History, TrendingUp } from "lucide-react";
      ...
      <main className="container mx-auto px-4 py-12 max-w-5xl">
        <div className="space-y-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-slate-50/50 p-8 rounded-2xl shadow-sm border border-slate-200 hover:shadow-md transition-shadow">
              <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center mb-6">
                <Target className="w-6 h-6 text-blue-600" />
              </div>
              <h3 className="text-xl font-bold mb-3 text-slate-900">Our Mission</h3>
              <p className="text-slate-600 leading-relaxed">
                To uplift the underprivileged sections of society by providing quality education, vocational training, and employment opportunities, ensuring no youth is left behind in the digital age.
              </p>
            </div>
            <div className="bg-slate-50/50 p-8 rounded-2xl shadow-sm border border-slate-200 hover:shadow-md transition-shadow">
              ...
              <p className="text-slate-600 leading-relaxed">
                A self-reliant and skilled Bihar where every youth has the capability, confidence, and opportunity to contribute meaningfully to the nation's growth and development.
              </p>
            </div>
            <div className="bg-slate-50/50 p-8 rounded-2xl shadow-sm border border-slate-200 hover:shadow-md transition-shadow">
              ...
              <p className="text-slate-600 leading-relaxed">
                Registered in 2007 (Reg No. 566), we are a trusted partner of BSDM, successfully running flagship programs like KYP and BSCFA across multiple centers in Jamui.
              </p>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-12 items-start">
              <div className="flex-1 space-y-6">
                ...
                <div className="max-w-none text-slate-600 [&_h3]:text-xl [&_h3]:font-bold [&_h3]:text-slate-900 [&_h3]:mt-6 [&_h3]:mb-2 [&_p]:mb-4 [&_p]:leading-relaxed [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-2 [&_li]:mb-1 [&_strong]:font-semibold [&_strong]:text-slate-900">
                  ...
                  <p>
                    As an accredited training partner of the <strong>Bihar Skill Development Mission (BSDM)</strong>, we operate state-of-the-art Skill Development Centers (SDCs). Our centers are equipped with modern computer labs, smart classrooms, and expert trainers who guide students through programs like the <strong>Kushal Yuva Program (KYP)</strong>.
                  </p>
                  ...
                  <ul>
                    <li><strong>Health & Family Welfare:</strong> Organizing free medical camps and awareness drives.</li>
                    <li><strong>Women Empowerment:</strong> Special vocational batches for women to encourage financial independence.</li>
                    <li><strong>Environmental Awareness:</strong> Tree plantation drives and cleanliness campaigns.</li>
                  </ul>
                </div>
              </div>
              <div className="flex-1 w-full space-y-6">
                <div className="aspect-video rounded-2xl overflow-hidden bg-white border border-slate-100 shadow-sm relative">
                  <img 
